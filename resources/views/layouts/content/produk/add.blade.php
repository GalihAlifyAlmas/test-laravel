...
<div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-8">
                   <form id="signupForm1" method="post" class="form-horizontal" action="{{  route('addproduks') }}" enctype="multipart/form-data">
                   @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                            <input type="number" class="form-control" id="harga" name="price" placeholder="Masukan Harga" />
                            </div>
                        </div>
